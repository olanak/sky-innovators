...
from typing import Optional # Already here, perfect.
...
async def upload_drone_footage(
    ...
    modules: str = Form(...), 
    project_id: Optional[int] = Form(None), # 👉 UPDATED: Now listens for project_id
    ...
    new_media = models.MediaFile(
        ...
        project_id=project_id # 👉 UPDATED: Saves the link to the DB
    )
    ...
    return {
        ...
        "file": {
            ...
            "size_mb": new_media.file_size_mb,
